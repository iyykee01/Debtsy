...
const BottomsheetTermsAndCondition = ({
  closePressed,
}: BottomsheetPrivacyAndPolicyProps) => {
  return (
    <ContentWrapper>
      <BottomSheetHeader title="Terms of Service" closePressed={closePressed} />
      <Spacer spaceTop="6%" />

      <TextComponent title="Terms of Service" fontSize="18px" fontReg />
      <Spacer spaceTop="8%" />
      <TextComponent
...
export default BottomsheetTermsAndCondition;
